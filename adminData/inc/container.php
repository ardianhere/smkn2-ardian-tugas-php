...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li class="dropdown">
        <a class="dropdown-toggle" data-toggle="dropdown" href="#" style="color: black;">Tentang Toko
        <span class="caret"></span></a>
        <ul class="dropdown-menu">
          <li><a href="#">Sosial Media</a></li>
        </ul>
      </li>
      <li><a href="Transaksi.php" style="color: black;">Transaksi</a></li>
      <li><a href=".././login/logout.php"  style="color: black;"><span class="glyphicon glyphicon-log-in"></span> Logout</a></li>
    </ul>
  </div>
</nav>
